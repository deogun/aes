...
public enum InternalRejectReason {
    ...
    CBC_INVALID_KEY(RejectReason.CBC_INVALID_KEY),
    CBC_NOT_AVAILABLE(RejectReason.CBC_NOT_AVAILABLE_ON_THIS_SYSTEM),
    CBC_INVALID_PARAMETERS(RejectReason.CBC_INVALID_PARAMETERS);
